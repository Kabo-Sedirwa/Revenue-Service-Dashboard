...
public class CookieFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        User userInSession = ManagementUtility.getLoginedUser(session);
        // 
        ...
        if (checked == null && conn != null) {
            String email = ManagementUtility.getBothNamesInCookie(req);
            try {
            	User user = DbInteractionUtility.findUser(conn, email);
